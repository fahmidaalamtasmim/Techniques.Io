...
<head>
    ...
    <!-- Css Styles -->
    <link rel="stylesheet" href="{{asset('t/css/bootstrap.min.css" type="text/css')}}">
    <link rel="stylesheet" href="{{asset('t/css/font-awesome.min.css" type="text/css')}}">
    <link rel="stylesheet" href="{{asset('t/css/elegant-icons.css" type="text/css')}}">
    <link rel="stylesheet" href="{{asset('t/css/flaticon.css" type="text/css')}}">
    <link rel="stylesheet" href="{{asset('t/css/nice-select.css" type="text/css')}}">
    <link rel="stylesheet" href="{{asset('t/css/barfiller.css" type="text/css')}}">
    <link rel="stylesheet" href="{{asset('t/css/magnific-popup.css" type="text/css')}}">
    <link rel="stylesheet" href="{{asset('t/css/jquery-ui.min.css" type="text/css')}}">
    <link rel="stylesheet" href="{{asset('t/css/owl.carousel.min.css" type="text/css')}}">
    <link rel="stylesheet" href="{{asset('t/css/slicknav.min.css" type="text/css')}}">
    <link rel="stylesheet" href="{{asset('t/css/style.css" type="text/css')}}">
</head>
