...
<html lang="en">
  <head>
    ...
    <title>Techniques.io Admin</title>
    <!-- plugins:css -->
          ...
          <li class="nav-item profile">
            <div class="profile-desc">
              <div class="profile-pic">
                ...
                @else
                <img class="img-xs rounded-circle" src="{{asset('uploads/adminuserphoto')}}/{{Auth::user()->photo}}" alt="">
                @endif
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="auth">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="{{route('product.category')}}">Add product category</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{route('w')}}">Add website link</a></li>
              </ul>
            </div>
          </li>
...
<li class="nav-item menu-items">
  ...
  <div class="collapse" id="t">
    <ul class="nav flex-column sub-menu">
      ...
      <li class="nav-item"> <a class="nav-link" href="{{route('topic.admin')}}"> Topic List </a></li>
      <li class="nav-item"> <a class="nav-link" href="{{route('clist')}}">Comment List </a></li>
    </ul>
  </div>
</li>
{{-- links with sub links --}}
...
{{-- scrape --}}
<li class="nav-item menu-items">
  <a class="nav-link" data-toggle="collapse" href="#scrape" aria-expanded="false" aria-controls="scrape">
    <span class="menu-icon">
      <i class="mdi mdi-table-large"></i>
    </span>
    <span class="menu-title">Scrape</span>
    <i class="menu-arrow"></i>
  </a>
  <div class="collapse" id="scrape">
    <ul class="nav flex-column sub-menu">
      <li class="nav-item"> <a class="nav-link" href="{{route('scrape')}}"> Scrape website </a></li>
    </ul>
  </div>
</li>
{{-- scrape --}}
...
{{-- 
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="profileDropdown">
                  ...
                  <div class="dropdown-divider"></div>
                  <a href="{{route('admin.users.edit')}}" class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                      <div class="preview-icon bg-dark rounded-circle">
                  ...
                  class="dropdown-item preview-item">
                    ...
                    <div class="preview-item-content">
                      <p  
                       ...
                       class="preview-subject mb-1"><span style="font-size:15px;padding-left:15px;">Log out</span></p>

                      
                    </div>
                   
                  </a>
                  <form  class="d-inline" id="logout-form" action="{{ route('logout') }}" method="POST" class="d-none">
                    @csrf
                </form>
                  <div class="dropdown-divider"></div>
