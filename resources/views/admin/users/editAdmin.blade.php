            ...
            <div class="card-body">
              ...
              <form class="forms-sample" method="POST" action="{{route('update.admin')}}">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputUsername1" value="{{Auth::user()->name}}" name="name">
                </div>
                <div class="form-group">
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                ...
                @endif
                  ...
                  <form class="forms-sample" method="POST" action="{{route('admin.photo')}}" enctype="multipart/form-data">
                    @csrf
